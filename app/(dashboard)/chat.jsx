...
const Chat = () => {
  ...
  const sendMessage = async () => {
    ...
    try {
      // Format messages for Claude API (exclude the initial assistant message)
...
setMessages(prev => [...prev, aiMessage])
  ...
  console.error('Error calling Claude:', error.response?.data || error)
  const errorMessage = {
    id: (Date.now() + 1).toString(),
    role: 'assistant',
